...
DeviceObject::Setter& DeviceObject::Setter::reqSetProperty(unsigned char epc,
	...
	return static_cast<DeviceObject::Setter&>(EchoObject::Setter::reqSetProperty(epc, edt));
}
...
DeviceObject::Getter& DeviceObject::Getter::reqGetProperty(unsigned char epc) {
	return static_cast<DeviceObject::Getter&>(EchoObject::Getter::reqGetProperty(epc));
}
...
DeviceObject::Informer& DeviceObject::Informer::reqInformProperty(
		unsigned char epc) {
	return static_cast<DeviceObject::Informer&>(EchoObject::Informer::reqInformProperty(epc));
}
...
DeviceObject::InformerC& DeviceObject::InformerC::reqInformProperty(
		unsigned char epc) {
	return static_cast<DeviceObject::InformerC&>(EchoObject::InformerC::reqInformProperty(epc));
}
