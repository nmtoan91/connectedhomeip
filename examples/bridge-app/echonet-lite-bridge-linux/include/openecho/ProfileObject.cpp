...
ProfileObject::Setter& ProfileObject::Setter::reqSetProperty(unsigned char epc,
		std::vector<unsigned char> edt) {
	return static_cast<ProfileObject::Setter&>(EchoObject::Setter::reqSetProperty(epc, edt));
}
...
ProfileObject::Getter& ProfileObject::Getter::reqGetProperty(
		unsigned char epc) {
	return static_cast<ProfileObject::Getter&>(EchoObject::Getter::reqGetProperty(epc));
...
ProfileObject::Informer& ProfileObject::Informer::reqInformProperty(
		unsigned char epc) {
	return static_cast<ProfileObject::Informer&>(EchoObject::Informer::reqInformProperty(epc));
...
ProfileObject::InformerC& ProfileObject::InformerC::reqInformProperty(
		unsigned char epc) {
	return static_cast<ProfileObject::InformerC&>(EchoObject::InformerC::reqInformProperty(epc));
