...
CHIP_ERROR EchonetWindowCoveringDelegate_IHouse::HandleMovementWithPercent(WindowCoveringType type, int openPercent)
{
...
CHIP_ERROR EchonetWindowCoveringDelegate_IHouse::HandleMovement(WindowCoveringType type)
{
    printf("\n\n\n[[[[[[[[[[[ EchonetWindowCoveringDelegate_IHouse HandleMovement %d ]]]]]]]]]]]]]\n\n\n\n\n\n",(int)type);
