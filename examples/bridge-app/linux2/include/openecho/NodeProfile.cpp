...
void NodeProfile::onNew(std::shared_ptr<EchoObject> eoj) {
	...
	std::shared_ptr<NodeProfile> profile = std::static_pointer_cast<NodeProfile>(eoj);
...
NodeProfile::Setter& NodeProfile::Setter::reqSetProperty(unsigned char epc,
	...
	return static_cast<NodeProfile::Setter&>(ProfileObject::Setter::reqSetProperty(epc, edt));
...
NodeProfile::Getter& NodeProfile::Getter::reqGetProperty(unsigned char epc) {
	return static_cast<NodeProfile::Getter&>(ProfileObject::Getter::reqGetProperty(epc));
}
...
NodeProfile::Informer& NodeProfile::Informer::reqInformProperty(
		unsigned char epc) {
	return static_cast<NodeProfile::Informer&>(ProfileObject::Informer::reqInformProperty(epc));
...
NodeProfile::InformerC& NodeProfile::InformerC::reqInformProperty(
		unsigned char epc) {
	return static_cast<NodeProfile::InformerC&>(ProfileObject::InformerC::reqInformProperty(epc));
}
...
std::shared_ptr<std::vector<unsigned char> > NodeProfile::getNumberOfSelfNodeInstances() {
	...
	if(getNode().get() != nullptr) {
		int size = (int)(getNode().get()->getDevices().size());
		edt.get()->resize(3);
		(*(edt.get()))[0] = (unsigned char)(((size >> 16) & 0xFF));
		(*(edt.get()))[1] = (unsigned char)(((size >> 8) & 0xFF));
		(*(edt.get()))[2] = (unsigned char)((size & 0xFF));
	}
...
std::shared_ptr<std::vector<unsigned char> > NodeProfile::getInstanceListNotification() {
	...
	if(getNode().get() != nullptr) {
		...
		edt.get()->push_back((unsigned char)size);
...
std::shared_ptr<std::vector<unsigned char> > NodeProfile::getSelfNodeClassList() {
	...
	if(getNode().get() != nullptr) {
		...
		int size = (int)classList.size();
		edt.get()->push_back((unsigned char)size);
		for(int i = 0; (i < size) && (i < 8); i++) {
			edt.get()->push_back((unsigned char)((classList.at(i) >> 8) & 0xFF));
			edt.get()->push_back((unsigned char)(classList.at(i) & 0xFF));
		}
	}
...
NodeProfile::Getter& NodeProfile::Getter::reqGetFaultStatus() {
	return static_cast<NodeProfile::Getter&>(ProfileObject::Getter::reqGetFaultStatus());
}

NodeProfile::Getter& NodeProfile::Getter::reqGetManufacturerCode() {
	return static_cast<NodeProfile::Getter&>(ProfileObject::Getter::reqGetManufacturerCode());
}

NodeProfile::Getter& NodeProfile::Getter::reqGetPlaceOfBusinessCode() {
	return static_cast<NodeProfile::Getter&>(ProfileObject::Getter::reqGetPlaceOfBusinessCode());
}

NodeProfile::Getter& NodeProfile::Getter::reqGetProductCode() {
	return static_cast<NodeProfile::Getter&>(ProfileObject::Getter::reqGetProductCode());
}
...
NodeProfile::Getter& NodeProfile::Getter::reqGetDateOfManufacture() {
	return static_cast<NodeProfile::Getter&>(ProfileObject::Getter::reqGetDateOfManufacture());
}

NodeProfile::Getter& NodeProfile::Getter::reqGetStatusChangeAnnouncementPropertyMap() {
	return static_cast<NodeProfile::Getter&>(ProfileObject::Getter::reqGetStatusChangeAnnouncementPropertyMap());
}

NodeProfile::Getter& NodeProfile::Getter::reqGetSetPropertyMap() {
	return static_cast<NodeProfile::Getter&>(ProfileObject::Getter::reqGetSetPropertyMap());
}

NodeProfile::Getter& NodeProfile::Getter::reqGetGetPropertyMap() {
	return static_cast<NodeProfile::Getter&>(ProfileObject::Getter::reqGetGetPropertyMap());
}
...
NodeProfile::Informer& NodeProfile::Informer::reqInformFaultStatus() {
	return static_cast<NodeProfile::Informer&>(ProfileObject::Informer::reqInformFaultStatus());
}

NodeProfile::Informer& NodeProfile::Informer::reqInformManufacturerCode() {
	return static_cast<NodeProfile::Informer&>(ProfileObject::Informer::reqInformManufacturerCode());
}

NodeProfile::Informer& NodeProfile::Informer::reqInformPlaceOfBusinessCode() {
	return static_cast<NodeProfile::Informer&>(ProfileObject::Informer::reqInformPlaceOfBusinessCode());
}

NodeProfile::Informer& NodeProfile::Informer::reqInformProductCode() {
	return static_cast<NodeProfile::Informer&>(ProfileObject::Informer::reqInformProductCode());
}

NodeProfile::Informer& NodeProfile::Informer::reqInformSerialNumber() {
	return static_cast<NodeProfile::Informer&>(ProfileObject::Informer::reqInformSerialNumber());
}

NodeProfile::Informer& NodeProfile::Informer::reqInformDateOfManufacture() {
	return static_cast<NodeProfile::Informer&>(ProfileObject::Informer::reqInformDateOfManufacture());
}

NodeProfile::Informer& NodeProfile::Informer::reqInformStatusChangeAnnouncementPropertyMap() {
	return static_cast<NodeProfile::Informer&>(ProfileObject::Informer::reqInformStatusChangeAnnouncementPropertyMap());
}

NodeProfile::Informer& NodeProfile::Informer::reqInformSetPropertyMap() {
	return static_cast<NodeProfile::Informer&>(ProfileObject::Informer::reqInformSetPropertyMap());
}

NodeProfile::Informer& NodeProfile::Informer::reqInformGetPropertyMap() {
	return static_cast<NodeProfile::Informer&>(ProfileObject::Informer::reqInformGetPropertyMap());
}
